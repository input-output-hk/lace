import { Serialization } from '@lace-lib/vendor';
...
import {
  ...
  buildCip8Request,
  parseCip8Response,
} from '../../../src/air-gapped/seed-signer/flows/cip8';
import {
  decodeCardanoMessageSignRequest,
  encodeCardanoCip8SignResponse,
} from '../../../src/air-gapped/seed-signer/messages/cardano-cip8-sign';
import { CardanoUrType } from '../../../src/air-gapped/seed-signer/ur-types';
import {
  DerivationPath,
  HARDENED_OFFSET,
  ROLE_PAYMENT,
} from '../../../src/air-gapped/seed-signer/value-objects/derivation-path.vo';
import { RequestId } from '../../../src/air-gapped/seed-signer/value-objects/request-id.vo';
import { Xfp } from '../../../src/air-gapped/seed-signer/value-objects/xfp.vo';

import type { SigningPath } from '../../../src/air-gapped/seed-signer/messages/cardano-cip8-sign';
