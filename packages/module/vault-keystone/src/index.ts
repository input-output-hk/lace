...
import { FEATURE_FLAG_KEYSTONE } from './const';
...
export { FEATURE_FLAG_KEYSTONE } from './const';
...
const multiPlatformModule = inferModuleContext({
  moduleName: ModuleName('vault-keystone'),
  feature: {
    willLoad: featureFlags =>
      featureFlags.some(flag => flag.key === FEATURE_FLAG_KEYSTONE),
    metadata: {
      name: 'Keystone',
      description: 'Air-gapped Keystone support (Cardano and Bitcoin)',
    },
  },
