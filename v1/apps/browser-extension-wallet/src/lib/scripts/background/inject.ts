...
const appLogger = process.env.NODE_ENV === 'development' ? console : dummyLogger;
...
const cip30WalletProperties: WalletProperties = {
  ...
  supportedExtensions: [{ cip: 95 }, { cip: 142 }]
};

const cip30WalletNamiProperties: WalletProperties = {
  // eslint-disable-next-line max-len
  ...
  walletName: 'Nami',
  cip30ApiDeviations: { getCollateralEmptyArray: true, onOffDummyMethods: true },
