...
import { BlockfrostNetworkInfoProvider } from '../../../src/blockfrost';
...
const blockResponse = {
  ...
  output: '9249073880',
  previous_block:
    'da56fa53483a3a087c893b41aa0d73a303148c2887b3f7535e0b505ea5dc10aa',
  size: 1050,
  slot: 37_767_194,
...
describe('BlockfrostNetworkInfoProvider', () => {
  ...
  test('stake', async () => {
    mockResponses(request, [['network', { data: mockedNetworkResponse }]]);
  ...
  test('eraSummaries', async () => {
    ...
    mockResponses(request, [
      ['network/eras', { data: blockfrostResponseBody }],
  ...
  test('genesisParameters', async () => {
    mockResponses(request, [['genesis', { data: mockedGenesisResponse }]]);
