...
Feature: Sign message
  ...
  Scenario: Extended view - Sign message - main account - show available addresses
    ...
    Then the list of all available addresses is shown and contains:
      ...
      | addr_test1qzkk4azpmv8etfx5tfq...x70z2nqqd80frq (Payment) |
      | addr_test1qqtwywurxyzpaj47fk2...x70z2nqqae5w3z (Payment) |
      | addr_test1qpxaz0jx5alxye49lr3...x70z2nqqwxwg6w (Payment) |
      | addr_test1qrn7uuaeq0un44ju0qy...x70z2nqq5c6lqf (Payment) |
      | addr_test1qpuggh7wq0tk3fl9tnq...x70z2nqqux74rq (Payment) |
      | addr_test1qz0qskuhrc7nsxy5zwr...x70z2nqqcn9rdy (Payment) |
      | addr_test1qqre74yrw27swrn4eff...x70z2nqqv47pa5 (Payment) |
      | addr_test1qz5ne6jq3kk4xdqre7a...x70z2nqqfajtmc (Payment) |
      | addr_test1qrtl6kgv2qu7cdwcrdk...x70z2nqqv2me65 (Payment) |
      | addr_test1qpqr8rep53qt3xpv82h...x70z2nqqmlc0y9 (Payment) |
      | addr_test1qqhdt5xfdp5gj63pyd0...x70z2nqqdwgxev (Payment) |
      | addr_test1qze50x9ayxq8c97qh27...x70z2nqq3rngdu (Payment) |
      | stake_test1uqhtmqaf72nw426t4r...n0839fsqh5r9lm (Stake)   |
  ...
  Scenario: Extended view - Sign message - additional account - show available addresses
    ...
    Then the list of all available addresses is shown and contains:
      ...
      | addr_test1qzcsy9ulqjfjyga36yt...q8x8u84q58umw7 (Payment) |
      | stake_test1uqvgpnt7r2q9prtect...srnr7r6sh4rlmr (Stake)   |
