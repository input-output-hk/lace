...
import { tweakTaprootPubKey, tweakTaprootPrivateKey } from '../../src/common';
...
describe('Taproot key tweaking (BIP341)', () => {
  ...
  it('tweaks private key correctly with internal pubkey', () => {
    ...
    const expected =
      'b91926939e4655dd519d6aeee5666cbb9b9856b8d6fe7fac5e160eee2847171a';
  ...
  it('throws on invalid pubkey length', () => {
    ...
    expect(() => tweakTaprootPubKey(badKey)).toThrow(
      'Internal public key must be 32 bytes (x-only format).',
    );
  });
