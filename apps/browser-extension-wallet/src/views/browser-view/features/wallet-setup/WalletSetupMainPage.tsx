...
import styles from '@views/browser/features/wallet-setup/WalletSetup.module.scss';
...
export const WalletSetupMainPage = (): ReactElement => {
  ...
  const handleStartHardwareOnboarding = () => {
    ...
    analytics.sendEventToPostHog(postHogOnboardingActions.hardware.SETUP_OPTION_CLICK);
  };
