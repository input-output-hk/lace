...
Feature: Send Transaction bundles - E2E
  ...
  Scenario: Extended view - Sending multiple assets and bundles E2E
    ...
    Then The Tx details are displayed as "package.core.transactionDetailBrowser.sent" for 4 tokens with following details:
      | address                                  | ada       | assets                      |
    ...
    And I click and open recent transactions details until find transaction with correct hash
    Then The Tx details are displayed as "package.core.transactionDetailBrowser.received" for 3 tokens with following details:
      | address                         | ada       | assets                      |
