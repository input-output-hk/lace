...
import { walletRoutePaths as routes } from './wallet-paths';
import { ActivityLayout } from './features/activity/components';
import { WalletSetup } from '../browser-view/features/wallet-setup';
import { AssetsView } from './features/assets';
import { Lock } from '../browser-view/components/Lock';
...
import { Portal } from '../browser-view/features/wallet-setup/components/Portal';
...
export const BitcoinBrowserViewRoutes = ({ routesMap = defaultRoutes }: { routesMap?: RouteMap }): React.ReactElement => {
  const {
    walletInfo,
    isWalletLocked,
    setCardanoCoin,
