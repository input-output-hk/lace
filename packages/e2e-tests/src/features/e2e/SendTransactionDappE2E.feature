...
Feature: Send Transactions from Dapp - E2E
  ...
  Scenario: Send ADA from DApp E2E
    ...
    Then The Tx details are displayed as "package.core.activityDetails.sent" for ADA with value: 3.00 and wallet: "WalletReceiveSimpleTransactionE2E" address
  ...
  Scenario: Send Token from DApp E2E
    ...
    And I click on a transaction: 1
    Then The Tx details are displayed as "package.core.activityDetails.sent" for ADA with value: "1.38" and LaceCoin2 with value: "2" and wallet: "WalletReceiveSimpleTransactionE2E" address
    When I open wallet: "WalletReceiveSimpleTransactionE2E" in: extended mode
    And Wallet is synced
    And I navigate to Transactions extended page
