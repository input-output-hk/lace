...
Feature: Send Transactions from Dapp - E2E
  ...
  Scenario: Send ADA from DApp E2E
    ...
    And I click "Close" button on "All done" page
    And I don't see DApp window
    And I switch to window with Lace
    And I navigate to Tokens extended page
    Then the sent amount of: "3" with fee: "feeValueDAppTx" for token "Cardano" is subtracted from the total balance in extended mode
