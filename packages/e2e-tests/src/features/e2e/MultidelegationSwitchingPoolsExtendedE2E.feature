...
Feature: Staking Page - Switching pools - Extended Browser View - E2E
  ...
  Scenario Outline: Extended View - Multidelegation - Delegate to multiple pools E2E - from <pools_before> pools to <pools_after> pools
    ...
    And I redelegate from "1" to "2" pools: "8BETA, OCEAN"
    And I navigate to Transactions extended page
    Then I can see transaction 1 with type "Delegation"
    When I navigate to Staking extended page
    And I open Overview tab
    Then I wait until delegation info card shows staking to "2" pool(s)
    And I redelegate from "2" to "10" pools: "8BETA, OCEAN, WOOF, PIANO, SMAUG, ZZZZX, ZZZG3, YATP, XSP, CENT"
    And I navigate to Transactions extended page
    Then I can see transaction 1 with type "Delegation"
    When I navigate to Staking extended page
    And I open Overview tab
    Then I wait until delegation info card shows staking to "10" pool(s)
    And I redelegate from "10" to "1" pools: "8BETA"
    And I navigate to Transactions extended page
    Then I can see transaction 1 with type "Stake Key De-Registration"
    When I navigate to Staking extended page
    And I open Overview tab
    Then I wait until delegation info card shows staking to "1" pool(s)
