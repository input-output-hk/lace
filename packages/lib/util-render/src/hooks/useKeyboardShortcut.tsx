...
const isApi1 = (params: Api1 | Api2): params is Api1 =>
  Array.isArray(params[0]);
const isApi2 = (params: Api1 | Api2): params is Api2 =>
...
export const useKeyboardShortcut: UseKeyboardShortcut = (
  ...params: Api1 | Api2
): void => {
  ...
  const handler = useCallback(
    (event: KeyboardEvent) => {
      const executeCallback =
        keyCodes.length === 0 || keyCodes.includes(event.code as KeyCode);
      if (executeCallback) {
        callback(event);
      }
    },
