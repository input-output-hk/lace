...
module.exports = {
  ...
  devtool: 'source-map',
  entry: {
    'sw-bundle': path.join(__dirname, 'lmp-bundle', 'sw-bundle.js'),
    'popup-bundle': path.join(__dirname, 'lmp-bundle', 'popup-bundle.js')
  },
  output: {
    filename: '[name].js',
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        {
          from: path.join(__dirname, 'apps', 'lace-platform', 'apps', 'midnight-extension', 'dist'),
          to: path.join(__dirname, 'dist'),
          globOptions: {
