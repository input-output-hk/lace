...
Before(
  {
    tags: '@Tokens-popup or @Transactions-Popup or @Staking-Popup or @LockWallet-popup or @Top-Navigation-Popup or @AddressBook-popup or @Common-Popup or @SendTx-Simple-Popup or @MainNavigation-Popup or @Settings-Popup or @NFTs-Popup or @NFT-Folders-Popup or @Send-Transaction-Metadata-Popup or @ForgotPassword or @Analytics-Settings-Popup or @Banxa-Popup'
  },
  async () => {
...
Before(
  {
    tags: '@DAppConnector or @DAppConnector-Extended'
  },
  async () => {
    await extendedViewRepositoryWalletInitialization([TestWalletName.DAppConnectorWallet]);
    await localStorageInitializer.disableShowingMultidelegationBetaBanner();
  }
);
...
Before(
  {
    tags: '@DAppConnector-Popup'
  },
  async () => {
    await popupViewRepositoryWalletInitialization([TestWalletName.DAppConnectorWallet]);
    await localStorageInitializer.disableShowingMultidelegationBetaBanner();
  }
);
