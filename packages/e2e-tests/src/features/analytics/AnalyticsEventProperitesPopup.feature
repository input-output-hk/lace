...
Feature: Analytics - Posthog - Event properties
  ...
  @LW-8352
  Scenario: Popup View - Analytics - Verify event properties - Send - Send button
  ...
  @LW-8353
  Scenario: Popup View - Analytics - Verify event properties - Send - Send NFT button
    Given I set up request interception for posthog analytics request(s)
  ...
  @LW-8354
  Scenario: Popup View - Analytics - Verify event properties - Send - Send token
    Given I set up request interception for posthog analytics request(s)
