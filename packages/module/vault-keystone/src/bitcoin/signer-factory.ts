...
import { BitcoinKeystoneTransactionSigner } from './signing/bitcoin-keystone-transaction-signer';
...
/**
 * Routes Bitcoin signing for air-gapped Keystone accounts. Construction is
 ...
 * wake (ADR-25).
 */
export class BitcoinKeystoneSignerFactory implements BitcoinSignerFactory {
  ...
  public createTransactionSigner(
    ...
    return new BitcoinKeystoneTransactionSigner({ masterFingerprint });
  }
  ...
  #extractAccountProps(
    ...
    const account = resolveSignerAccount({
      ...
      factoryName: 'BitcoinKeystoneSignerFactory',
    });
