...
export enum PostHogAction {
  ...
  StakingBrowsePoolsAddPoolClick = 'staking | browse pools | add pool | click',
  ...
  StakingManageDelegationConfirmationNextClick = 'staking | manage delegation | confirmation | next | click',
  ...
  StakingManageDelegationDelegationRatioSliderVolumPinDrag = 'staking | manage delegation | delegation ratio slider | volum pin | drag',
