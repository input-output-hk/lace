export const cookiePolicy = {
  ...
  <p>Our Products, like many others, use cookies in order to work properly.</p>
  <p>
    Cookies are small text files, often including unique identifiers, that are downloaded onto your device when
    you access our Products. They allow us to recognize your device and store some information about your
    preferences or past actions on our website, ultimately allowing us to improve your experience. Cookies are
    very useful and enhance your user experience.
  </p>
  <p>
    To find more information, please go to
    <a href='https://www.allaboutcookies.org'>www.allaboutcookies.org</a> if you are
    located in the United States. If you are located in Europe, please go to
    <a href='https://www.youronlinechoices.eu'>www.youronlinechoices.eu</a>.
  </p>
  <subtitle>How we use cookies</subtitle>
  <p>
    We or our third-party partners may collect information using cookies, pixel tags, or similar technologies. We
    use cookies to provide you with services, to set your preferences, and to understand how you interact with our
  ...
  <p>
    ...
    which amount to a request for services, such as setting your privacy preferences, logging in, or filling in
    forms.
  </p>
  <p>
  ...
  <p>
    ...
    <br />
    We use a set of cookies that are optional for the Products to function. These cookies allow our Products to
    remember choices you make when you visit our Products in order to provide enhanced, more personalized features
    to you. They are usually only set in response to information provided to the Products in order to personalize
    and optimize your experience.
  </p>
  <subtitle>How to disable cookies</subtitle>
  <div>
    A lot of web browsers allow control of cookies through the settings. You can prevent the setting of cookies by
    adjusting the browser settings (see your browser's Help section for the instructions). Find out how to manage
    cookies on popular browsers:
    <ul>
      <li>
        <a href="https://support.google.com/accounts/answer/61416">Google Chrome</a>
      </li>
      <li>
        <a href="https://support.microsoft.com/en-gb/help/4468242/microsoft-edge-browsing-data-and-privacy-microsoft-privacy">
          Microsoft Edge
        </a>
      </li>
      <li>
