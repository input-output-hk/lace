...
describe('Testing normalizePercentages function', () => {
  test('Should correctly normalize numbers to 0 decimal places', () => {
  ...
  test('Should correctly normalize numbers to 1 decimal places', () => {
  ...
  test('Should correctly normalize numbers to 2 decimal places', () => {
  ...
  test('Should correctly normalize more numbers to 2 decimal places', () => {
  ...
  test('Should throw on incorrect input sum', () => {
